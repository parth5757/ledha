...
class Payment(models.Model):
    ...
    order = models.ForeignKey("orders.SalesOrder", on_delete=models.PROTECT, blank=True, null=True, related_name="payments")
    purchase = models.ForeignKey("purchase.PurchaseOrder", on_delete=models.PROTECT, blank=True, null=True, related_name="payments")
    payment_type = models.CharField(max_length=10,choices=PAYMENT_TYPE_CHOICES)
    amount = models.DecimalField(max_digits=12, decimal_places=2)
    method = models.CharField(max_length=15, choices=METHOD_CHOICES, default="cash")
    refrence_number = models.CharField(max_length=100, blank=True)
